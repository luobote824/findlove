...
public class Constant {
    ...
    public static final String INIT_SIGNATURE="该用户很懒，没有留下任何东西";
    /**
     * 固定显示用户个数
     */
     ...
     * 默认用户头像
     */
    public static final String MALE_PHOTO = "group1/M00/00/00/eE_bGWJ7MEWAK6xNAADI7cJ1ZgM303.jpg";
    public static final String FEMALE_PHOTO = "group1/M00/00/00/eE_bGWJ7MKiAENITAAC5Z0gXPcw273.jpg";
